...
&#8195;&#8195;In the optional model, it is divided into two modes which are the human to human mode and the human-machine mode. In human to human mode, this application has a function of communicating with foreign teachers, which is a paid function. We can also choose the free one,
